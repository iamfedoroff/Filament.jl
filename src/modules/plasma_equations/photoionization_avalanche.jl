function init_photoionization_avalanche(unit, grid, field, medium, params)
    ALG = params["ALG"]
    EREAL = params["EREAL"]
    KDEP = params["KDEP"]
    rho0 = params["rho0"]
    ...
    # Problem:
    if isa(grid, Grids.GridT)
        p = (tabfuncs, fiarg, frhonts, Ravas, grid.t, field.E)
        ...
        for i=1:grid.Nr
            ...
            pi = (tabfuncs, fiarg, frhonts, Ravas, grid.t, Ei)
