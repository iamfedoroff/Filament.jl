...
function PlasmaEquation(unit, dt, n0, w0, params)
    init = params["init"]
    prob, extract, kdrho_func = init(unit, n0, w0, params)

    p = (prob, dt, extract, kdrho_func)
